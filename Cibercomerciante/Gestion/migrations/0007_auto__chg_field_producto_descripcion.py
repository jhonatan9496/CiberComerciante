...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'Gestion_producto', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Producto.descripcion'
        db.alter_column(u'Gestion_producto', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=15))
