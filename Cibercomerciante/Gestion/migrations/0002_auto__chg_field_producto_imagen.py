...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Producto.imagen'
        db.alter_column(u'Gestion_producto', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Producto.imagen'
        db.alter_column(u'Gestion_producto', 'imagen', self.gf('django.db.models.fields.CharField')(max_length=250))
    ...
    models = {
        ...
        u'Gestion.usuario': {
            ...
            'empresa': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Gestion.Empresa']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permisos': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Gestion.Permisos']"}),
