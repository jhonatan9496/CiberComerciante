...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Gestion_factura', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('num_factura', self.gf('django.db.models.fields.IntegerField')()),
            ('fecha_factura', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('comprador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Gestion.Empresa'])),
            ('cliente', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'Gestion', ['Factura'])

        # Adding model 'ItemFactura'
        db.create_table(u'Gestion_itemfactura', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('factura', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Gestion.Factura'])),
        ))
        db.send_create_signal(u'Gestion', ['ItemFactura'])


    def backwards(self, orm):
        # Deleting model 'Factura'
        db.delete_table(u'Gestion_factura')

        # Deleting model 'ItemFactura'
        db.delete_table(u'Gestion_itemfactura')
    ...
    models = {
        ...
        u'Gestion.factura': {
            ...
            'cliente': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'comprador': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Gestion.Empresa']"}),
            'fecha_factura': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num_factura': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        u'Gestion.itemfactura': {
            'Meta': {'object_name': 'ItemFactura'},
            'cantidad': ('django.db.models.fields.IntegerField', [], {}),
            'factura': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Gestion.Factura']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'producto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Gestion.Producto']", 'null': 'True', 'blank': 'True'})
        },
        u'Gestion.itemtmp': {
        ...
        u'Gestion.producto': {
            ...
            'unidades': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
        u'Gestion.sector': {
