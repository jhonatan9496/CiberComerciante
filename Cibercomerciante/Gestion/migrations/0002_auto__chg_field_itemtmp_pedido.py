...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemTmp.pedido'
        db.alter_column(u'Gestion_itemtmp', 'pedido_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Gestion.PedidoTmp']))

    def backwards(self, orm):

        # Changing field 'ItemTmp.pedido'
        db.alter_column(u'Gestion_itemtmp', 'pedido_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Gestion.Pedido']))
